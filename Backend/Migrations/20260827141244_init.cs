        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MedsTaken = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 0, "1", "Test User 1", "test1@email.com", false, true, null, "TEST1@EMAIL.COM", "TEST1@EMAIL.COM", null, null, false, "1", false, "test1@email.com" },
                    { 2, 0, "2", "Test User 2", "test2@email.com", false, true, null, "TEST2@EMAIL.COM", "TEST2@EMAIL.COM", null, null, false, "2", false, "test2@email.com" }
                });
